...
export default function OrderAgain() {
  ...
  const handleClick = ()=>{
    ...
    let apiURL = `https://api.whatsapp.com/send?phone=${phone}&text=${"Pedido feito pelo site: \n" + messageContent}`
    window.open(apiURL)
  }
  ...
  return (
      <div className={styles.container}>
        ...
        <Input name="name" settername={setInputName} placeholder="Nome Completo" />
        <Input name="number" setternumber={setInputNumber} placeholder="Número (Whats App)"/>
        <Input name="address" setteraddress={setInputAddress} placeholder="Endereço (Rua, Número, Bairro)" />
